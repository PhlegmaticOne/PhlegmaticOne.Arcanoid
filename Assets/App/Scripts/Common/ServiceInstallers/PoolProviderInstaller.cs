...
namespace Common.ServiceInstallers
{
    public class PoolProviderInstaller : ServiceInstaller
    {
        ...
        [SerializeField] private UnityObjectPoolInstaller<WallParticle> _sideWallParticlesInstaller;
        ...
        public override void InstallServices(IServiceCollection serviceCollection)
        {
            ...
            poolBuilder.AddPool(_sideWallParticlesInstaller.CreateObjectPool(poolContainer.transform));
