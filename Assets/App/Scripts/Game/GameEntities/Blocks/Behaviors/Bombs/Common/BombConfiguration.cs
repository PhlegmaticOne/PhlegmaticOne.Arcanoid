...
namespace Game.GameEntities.Blocks.Behaviors.Bombs.Common
{
    ...
    public class BombConfiguration : ScriptableObject
    {
        ...
        [SerializeField] 
        [ShowIf("@this._blockAffecting == BlockAffectingType.Damage || this._blockAffecting == BlockAffectingType.BothAndSeparate")]
        ...
        [SerializeField] 
        [ShowIf("@this._blockAffecting == BlockAffectingType.Destroying || this._blockAffecting == BlockAffectingType.BothAndSeparate")]
